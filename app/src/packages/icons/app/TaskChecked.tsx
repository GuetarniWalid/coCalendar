...
export const TaskChecked: React.FC<IconProps> = ({ size = 24, color = 'currentColor', width, height, outlineColor = 'white' }) => {
  ...
  return (
    <Svg width={iconWidth} height={iconHeight} viewBox='0 0 23 53' fill='none'>
      <Path d='M22.6991 15.9923C22.6991 8.99228 16.724 4.99229 11.6991 4.99229C5.53879 4.99229 5.22508e-05 6.5 5.22584e-05 0L0 53C0 53 0.5 28.1122 11.6991 26.9923C16.6991 26.4923 22.6991 22.9923 22.6991 15.9923Z' fill={outlineColor} />
      <Path
        fillRule='evenodd'
        clipRule='evenodd'
