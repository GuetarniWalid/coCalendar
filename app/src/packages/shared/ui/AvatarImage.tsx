...
function AvatarImageBase(props: AvatarImageProps) {
  const { size = DEFAULT_SIZE, contentFit = 'cover', borderRadius = size / 2, testID } = props;
...
export const COMMON_FEMALE_HOME_DAILY_LIFE: BuildAvatarUrlOptions[] = [
  { persona: 'adult-female', activity: 'home_daily_life', name: 'awakening', extension: 'webp' },
  { persona: 'adult-female', activity: 'home_daily_life', name: 'coffee_break', extension: 'webp' },
  { persona: 'adult-female', activity: 'health_wellbeing', name: 'sleep', extension: 'webp' },
  { persona: 'adult-female', activity: 'health_wellbeing', name: 'rest', extension: 'webp' },
  { persona: 'adult-female', activity: 'leisure_creativity', name: 'reflection', extension: 'webp' },
];
